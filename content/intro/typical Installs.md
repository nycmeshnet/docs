...
* In the first category is equipment that "speaks" [AirMAX](https://dl.ubnt.com/datasheets/airmax/UBNT_DS_airMAX_TDMA.pdf) (AirMax protocol).<br/>
Some hubs and supernodes have antennas covering a sector, or 360°, that "speak" AirMax. To connect to those, you need to install on your roof an antenna that understands that same AirMax protocol (see [Ubiquiti](/hardware) equipment).<br/>
...
OmniTik not located next to the Litebeam<br/>
